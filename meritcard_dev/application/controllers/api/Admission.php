           ...
           $flag = $this->input->post('flag');
                ...
                switch ($flag) {
                  ...
                  case "admission_add_student":
                   ...
                   if($res)
                   {
                        $dataTosend = ['status'=>true, 'msg'=>'success_msg', 'Student add successfully', 'body'=>$res];
                        echo json_encode($dataTosend); die();
                   }else{
                    ...
                    case "add_message":
                      // print_r($this->input->post());die;
                          ...
                          //  echo  $_FILES['document_attached']['name'];die;
                            ...
                            $res  = $this->cm->save('massages_tbl',['student_id'=>$student_id, 'file_type'=>$img_name, 'massage'=>$massage, 'document_attached'=>$img, 'date'=>$date]);
                            //echo $res;
