...
<div class="content-wrapper">
  <div class="container-full">
    ...
    <section class="content">
      <form action="<?php echo base_url().'Event/updateEvent/'.$event['id']; ?>" method="POST">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  <div class="row">
                     ...
                     <select multiple class="selectpicker form-control" value="<?php echo $event['room']?>" name="room" id="number-multiple" data-container="body" data-live-search="true" title="Select Room" data-hide-disabled="false" data-actions-box="true" data-virtual-scroll="false">
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="title" value="<?php echo $event['title']?>" id="newstitle" placeholder="name@example.com" name="newstitle">
                      ...
                      <div class="col-lg-6 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                          <div class="form-floating mb-2 w45">
                            <input type="time" class="form-control" name="ftime" value="<?php echo $event['ftime']?>" id="timeform" placeholder="name@example.com" name="timeform">
                            <label for="timeform">From Time</label>
                          </div>
                          <span class="mr--1 ml--1">-</span>
                          <div class="form-floating mb-2 w45">
                            <input type="time" class="form-control" name="to_time" value="<?php echo $event['totime']?>" id="timeto" placeholder="name@example.com" name="timeto">
                      ...
                      <div class="form-floating mb-2 mycheckboxdiv">
                        ...
                        <input type="text" class="form-control" name="date" value="<?php echo $event['date']?>" id="todatepicker" placeholder="name@example.com" name="newstitle">
                      ...
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="fees" value="<?php echo $event['fees']?>" id="newstitle" placeholder="name@example.com" name="newstitle" value="">
                     ...
                     <div class="col-lg-6">
                       ...
                       <div class="formsetting mb-3">                     
                     <select class="selectpicker form-control" name="etype" value="<?php echo $event['type']?>" id="number-multiple" data-container="body" data-live-search="true" title="Evant Type" data-hide-disabled="false" data-actions-box="true" data-virtual-scroll="false">
                     ...
                     <textarea id="summernote" name="description"><?php echo $event['description']?></textarea>

                    </div>
                  </div>
                      <div class="col-lg-12 mt-3 mb-3">
                      	<button type="reset" class="btn mt-10">Cancel</button> 
                         <button type="Submit" class="btn btn btn-primary mt-10 waves-effect">Update</button>
                     </div>
                    </div>
                  </div>
                </div>
