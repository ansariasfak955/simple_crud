					...
					<?php }} } ?>  
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                       <div class="form-floating mb-3">
                         <input type="datetime-local"  id = 'dt1_1' no = '1'  class="form-control chck_date1"  name="timein[]">
                         <label for="timein" class="time-title">Time in <span class= 'text-danger'></span> </label>
                       </div>

                     </div>
                     <div class="col-lg-3 col-md-4 col-sm-6">
                       <div class="form-floating mb-3">
                         <input type="datetime-local" id = 'dt2_1'  class="form-control chck_date2" no = '1' name="timeout[]">
                         <label for="timeout" class="time-title">Time out <span class= 'text-danger'></span> </label>
                       </div>
                     </div> 
 ...
 <script src="<?= base_url() ?>assets_pages/js/bootstrap-select.js"></script>
  ...
  $('body').on('click','.srarch_sec', function (){
         ...
         <button type="button" class="btn btn-light">${rowIdx}</button></div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
					...
					<?php }} } ?>  
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                       <div class="form-floating mb-3">
                         <input type="datetime-local" id = 'dt1_${rowIdx}' no = '${rowIdx}' class="form-control chck_date1" name="timein[]">
                         <label for="timein" class="time-title">Time in <span class= 'text-danger'></span> </label>
                       </div>
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6">
                       <div class="form-floating mb-3">
                         <input type="datetime-local" id = 'dt2_${rowIdx}' class="form-control chck_date2" no = '${rowIdx}'   name="timeout[]">
                         <label for="timeout" class="time-title">Time out <span class= 'text-danger'></span> </label>
                       </div>
                     </div>
                   <div class="col-lg-1 col-md-4 col-sm-6">
   ...
   $('body').on('change',".chck_date2",function(){
       
       var no  = $(this).attr('no');
       var d1 =  $('#dt1_'+no).val();
       var d2 = $(this).val(); 
      // console.log(no +' ==jk== '+ d1);
      var res =  BetweenTime(d1,d2);
          res = parseInt(res)
    
          if(res <= 0){
               console.log(  'con== 1');
              $(this).parent().find('label').find('span').html('Invalid date time'); 
              $(this).val('');
              var m_this = $(this);
             setTimeout(function(){ m_this.parent().find('label').find('span').html(''); }, 3000)
          }
    ...
    $('body').on('change',".chck_date1",function(){
