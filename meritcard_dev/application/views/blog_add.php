                        ...
                        <div class="mb-4 previewimg">
                          <label for="imgupload" class="drag_button">
                            <div class="drag_buttons">
                              ...
                              <img class="previewimgs" src="<?= (isset($b_logs[0]->featured_Image))? base_url('assets/blog/') .$b_logs[0]->featured_Image : base_url('assets_pages/images/avatar-13.png') ?>" class="imgpreview" alt="your image">
                            </div>
                          </label>
                          <input type="file"  accept="image/*"  onchange="readURL(this);" id="imgupload" name= 'image' style="display: none;">
