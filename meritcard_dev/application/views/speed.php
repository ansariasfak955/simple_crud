...
<body>
		...
		<hr style= "background-color: chartreuse ;padding: 10px; margin:5px;">
			...
			<video width="640" height="267"  id="video-active"  style = 'bodder:1px solid red' controls autoplay  >
    ...
    function showResults() {
      ...
      return false; 
       ...
       function palys(){
                  ...
                  var v_1 = "<?= base_url('/assets/video/AdmissibleAgony_1.mp4') ?>";
                  var v_2 = "<?= base_url('/assets/video/AdmissibleAgony_2.mp4') ?>";
                  var v_3 = "<?= base_url('/assets/video/AdmissibleAgony_3.mp4') ?>";
           ...
           'https://s3.eu-central-1.amazonaws.com/pipe.public.content/short.mp4',
            'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4'];*/
             ...
             let m_time =  Math.floor($("#video-active").get(0).currentTime);            
                  ...
                  let cust_url = 0;  
                    if( (m_speed >= '5') && (m_speed < '10'))
                    {   console.log("speed under 100 to 150  == "+ m_speed );
                      cust_url = '0';
                        
                    }else  if( (m_speed >= '11') && (m_speed < '50'))
                            {   console.log("speed under 150 to 170  == "+ m_speed );
                                     cust_url = '1';
                                 }else  if( (m_speed >= '50') && (m_speed < '2000')) {
                                          console.log("speed under 170 to 2000  == "+ m_speed );
                                        cust_url = '2';
                                 }
                    if(old_url == cust_url)
                    {
