                ...
                <div class="row">
                  <!--<div class="col-lg-12">-->
                      ...
                      <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="address1" placeholder="" name="address"
                            value="<?= isset($school_pro[0]->address)? $school_pro[0]->address :'' ?>" required >
                        
                      </div>
                      <div class="col-6">
                          <label for="snumber">School Phone Number</label>
                        <input type="number" class="form-control" id="snumber" placeholder="" name="mobile"
                                value="<?= isset($school_pro[0]->mobile)? $school_pro[0]->mobile :'' ?>" required >
                      ...
                      <div class="col-6">
                       ...
                       <div class="col-6 ">
                          ...
                          data-container="body"   name = 'state_id' required 
                        ...
                        <div class="col-6">
                            ...
                            <select class=" form-control" name = 'city_id'  required   id="citys" data-container="body" 
                      ...
                      <div class="col-6">
                        ...
                        <input type="number" class="form-control" id="enrollment" placeholder="" required
                      ...
                      <div class="">
                       <!-- <button type="reset" class="mt-4s btn btn-light mr-3 mr--1" data-bs-dismiss="modal">Cancel</button>-->
                        <button type="submit" class="mt-4s mr-3 btn btn-success shadow">Update Profile</button>
                      </div>
