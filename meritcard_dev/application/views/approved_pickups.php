   ...
   <div class="container-full">
     ...
     <div class="content-header">
       <div class="tabls-title">
         <a href="<?= base_url('Student/parents/') ?>" class="">Parents</a>
         <a href="<?= base_url('Student/family/') ?>" class="">Family</a>
         <a href="<?= base_url('Student/approved_pickups/') ?>" class="active">Approved Pickups</a>

       </div>
       <div class="d-flex align-items-center">
         <div class="w-100s">
           <h4 class="page-title">APPROVED PICKUP LIST</h4>
                       ...
                       <td>  
                           ...
                           <div class="student_list">
                            ...
                            <?php  foreach($val->data as $value){  ?>
                             ...
                             ?>  
                                <a href="#"  data = "<?= base64_encode(json_encode($val)) ?>" class="addSparent">+ Add another approved pickup</a>
                        ...
                        <?php   }else{ ?>
                           ...
                           <a href="#" data = "<?= base64_encode(json_encode($val)) ?>" class="btn btn-primary waves-effect waves-light addSparent">Add Approved Pickups </a>
                             <?php }?>
                        

                       </td>
                       <td class="text-center"><a href="#" class="btn-light btn">Add Info</a></td>
     ...
     <div class="modal-content">
       ...
       <div class="modal-body box-body">
        <form action="<?= base_url('Student/edit_Parents') ?>" method="post">
           ...
           <div class="form-floating mb-3">
             <input type="tal" class="form-control" id="edit_mobile"  name="mobile" maxlength="10" title="Please use a 10 digit telephone number" 
       ...
       <div class="modal-body">
         ...
         <div class="box-body">
          ...
          <div class="tab-content">                                     
           ...
           <input type = 'hidden'  name = 'relational' value = 'Approved Pickup'>
           <div class="form-floating mb-3">
             <input type="email" class="form-control" name="email">
             <label for="emailaddres">Email Address</label>
           </div>
           <div class="form-floating mb-3">
             <input type="tel" class="form-control" name="mobile" maxlength="10" title="Please use a 10 digit telephone number" 
                    pattern="[0-9]{10}" required  >
           ...
           <div class="mb-3">
             <div class="suggest mt-2">
            		...
            		<input text="search" id="sch_perent" placeholder="type here..." class="form-control input-pad" />	    	    
              <div id="result_2"></div>
...
<script>
     ...
     $("body").on('click','.addSparent',function(){                                                    
           ...
           $('.p_title').html('Add family for '+ p_data.name);                 
