...
<body>
    <div class="container-fluid register">
        ...
        <!--start form-->
        <form action="<?php echo base_url('User/registerData')?>" method="POST" enctype="multipart/form-data">
            <div class="row justify-content-center" style="font-weight: 500;">
                ...
                Email :
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="text" name="email" class="form-control" placeholder="Enter Your Email" required aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                </div>  
            </div>
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                <div class="col-sm-4">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="number" name="number" class="form-control" placeholder="Enter Your Number" required aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                ...
                Password :
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="password" name="password" class="form-control" placeholder="Enter Your Password" required aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                </div>  
            </div>
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                <div class="col-sm-4">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="date" name="dob" class="form-control" placeholder="Enter Your Number" required aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                ...
                <div class="col-sm-4">
                    File Uploade :
                <div class="mb-3">
                        <input class="form-control" name="image1" id="image1" type="file" id="formFile">
                    </div>
                </div> 
            </div>
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                ...
                <div class="col-sm-4">
                    <div class="mb-3">
                        <input class="form-control" name="image2" id="image2" type="file" id="formFile">
                    </div>
                </div>
            </div>
