                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add User Subscription</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>User_subscription"<button class="btn btn-info" style="float:right;">View  Subscription</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>User_subscription/add_subscription_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
