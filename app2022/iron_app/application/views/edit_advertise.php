            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Advertise"<button class="btn btn-info" style="float:right;">View Advertise</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg');   ?>
                                ...
                                <h6 class="card-subtitle"></h6>
                                 <div class="row">
                                <div class="col-md-4">
                                <h4 class="card-title">About Advertise
                                </h4></div>
                                <div class="col-md-8">
                                 <img src="<?php echo base_url();?>upload/advertise/<?php echo $records[0]->    advertise_image;?>" style="height:80px; width:100px; float:right;"><br>
                                 </div>
                                 </div>
                                                                  
                            </div>
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Advertise/update_row" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="inputfname" class="control-label col-form-label">Advertise name</label>
                                            <input type="text" name="advertisename" class="form-control" id="inputfname" value="<?php echo $records[0]->advertise_name;?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="inputlname2" class="control-label col-form-label">Advertise Url</label>
                                            <input type="text" name="adertiseurl" class="form-control" id="inputlname2" value="<?php echo $records[0]->advertise_url;?>">
                                        </div>
                                    </div>
                                     ...
                                     <label for="cono" class="control-label col-form-label">Advertise Image</label>
                                     <input type="hidden" name="oldimage" value="<?php echo $records[0]->   advertise_image;?>">
                                     <input type="hidden" name="uid" value="<?php echo $records[0]->advertisements_id;?>">
                                    <div class="input-group mb-3">
                                                    
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Advertise Image</span>
                                        </div>
