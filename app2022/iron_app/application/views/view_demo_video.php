                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Introduction Video</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
          <a href="<?php echo base_url();?>Demo_video/add_demo"><button class="btn btn-info" style="float:right;">Add Introduction Video</button></a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                     ...
                                     <source src="<?php echo base_url()?>/upload/defaencodevid/<?php echo $row->video_url;?>" type="video/mp4">
                                            ...
                                            <td><?php echo $row->description;?></td>  
                                        	 <td><a href="<?php echo base_url()?>Demo_video/add_answer/<?php echo $row->id;  ?>"><button type="button" class="btn btn-success">Add Quiz</button></a></td>
                                            <td><a href="<?php echo base_url()?>Demo_video/edit/<?php echo $row->id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Delete Demo Video</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this demo video.</h4>
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>Demo_video/delete/<?php echo $row->id; ?>">
