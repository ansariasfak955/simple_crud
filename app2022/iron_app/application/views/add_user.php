...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>User/add_user_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="inputfname" class="control-label col-form-label">First Name</label>
                                                <input type="text" name="fname" class="form-control" id="inputfname" placeholder="First Name Here" required>
                                            </div>
                                        </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="inputlname2" class="control-label col-form-label">Last Name</label>
                                            <input type="text" name="lname" class="form-control" id="inputlname2" placeholder="Last Name Here" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" autocomplete="off" class="form-control" id="email1" placeholder="--@--" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="wen1" class="control-label col-form-label">Password</label>
                                            <input type="password" autocomplete="off" name="password" class="form-control" id="wen1" placeholder="***" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12  col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="contactno" class="form-control" id="cono" placeholder="Contact No Here" oninput="maxLengthCheck(this)" required maxlength = "10" min = "1" max = "">
                                        </div>
                                    </div>
