            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Demo_video/select_demo"<button class="btn btn-info" style="float:right;">View Questions</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-8">
                        <div class="card">
                            ...
                            <form method="POST" action="<?php echo base_url();?>Demo_video/add_pass_ans_qs" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
