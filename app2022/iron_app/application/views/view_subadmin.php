...
<body>
     ...
     <?php include('header.php');?> 
	  ...
	  <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Subadmin/index"><button class="btn btn-info" style="float:right;">Add Employees</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
  ...
  <?php $fail = $this->session->flashdata('error_msg'); ?>
   <?php $updd = $this->session->flashdata('successn_msg'); ?>
  <?php if($succ || $fail || $updd){?>
            ...
            <td><select id="statuss" name="status" size="1" onChange="stat(this.value,<?php echo $row->id; ?>)">
              <?php $status = $row->status; ?>
                                    ...
                                    <option value="0" <?php if($status == '0') echo "selected"; ?>>Inactive</option>
                                           ...
                                           <td>
<a href="<?php echo base_url()?>Subadmin/update_rows/<?php echo $row->id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this Employees.</h4>                       
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>Subadmin/delete/<?php echo $row->id; ?>">
...
{ xmlhttp = new XMLHttpRequest();
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
      ...
      xmlhttp.open("GET","<?php echo base_url(); ?>Subadmin/status?status="+strs+ "&id="+id,true);
     // alert("<?php echo base_url(); ?>Subadmin/status?status="+strs+ "&id="+id);
    xmlhttp.send();
