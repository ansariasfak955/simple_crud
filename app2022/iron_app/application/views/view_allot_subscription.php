            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Allot Free Subscription</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Allot Subscription</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
          <a href="<?php echo base_url();?>Allot_subscription/add_allot_subcription"><button class="btn btn-info" style="float:right;">Add Allot Subscription</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <form method="POST" style="margin-bottom:10px;" action="<?php echo base_url()?>Allot_subscription/index">
            <div class="col-md-12">
             <div class="row">
...
<button type="submit" name="search" class="btn btn-success" style="margin-top:29px;"><i class="fa fa-search"></i> Search</button>
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            ...
                                            $sq = $this->db->query("select * from dlc_course_package where  pack_id = '$pk'");
                                                ...
                                                <td>
                                    <select id="statuss" name="status" size="1" onChange="stat(this.value,<?php echo $row->allot_sub_id;?>)">
            ...
            <td>
<!-- <a href="<?php echo base_url()?>User_subscription/edit/<?php echo $row->user_sub_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a> -->
 <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->allot_sub_id; ?>"><i class="ti-trash"></i></a>
       
       
       </td>
                                            </tr><?php $i++;?>
                                            
                                            <div id="deletems<?php echo $row->allot_sub_id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Delete Allot Subscription</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this Allot Subscription.</h4>
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>User_subscription/delete/<?php echo $row->allot_sub_id; ?>">
...
//alert(id);
 xmlhttp = new XMLHttpRequest();
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
      ...
      xmlhttp.open("GET","<?php echo base_url();?>Allot_subscription/status?status="+strs+ "&id="+id,true);
