...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg'); 
  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Home_slider/add_home_slider_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
