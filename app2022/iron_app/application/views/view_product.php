...
<body>
    ...
    <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Product/add_product"><button class="btn btn-info" style="float:right;">Add Package</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                                ...
                                                <?php $p_img = json_decode($row->prod_image);  ?>
                                                <td><img height="50px"width="50px" src="<?= base_url('common_uploads/product_images/'.$p_img[0])?>" alt=""></td>
                                    ...
                                    <option value="0" <?php if($row->status == '0') echo "selected"; ?>>Inactive</option>
                                           ...
                                           <td>
<a href="<?php echo base_url('Product/edit/').$row->prod_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
 <a href="<?php echo base_url('Product/delete/').$row->prod_id;?>"onclick="return confirm('Are you sure ?')"><i class="ti-trash"></i></a>
