...
<body>
    ...
    <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Parents/add_parents"><button class="btn btn-info" style="float:right;">Add Parents</button></a>
                    </div> -->
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <!--  <form method="POST" style="margin-bottom:10px;" action="<?php echo base_url()?>Parents/index">
            <div class="col-md-12">
             <div class="row">
             ...
             <input type="text" id="search-box" name="prt" class="form-control" placeholder="User Name">
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->parents_email;?></td>                                               
                                                <td><?php echo $row->parents_contact;?></td>
                                              
                                               <!--  <td><a href="<?php echo base_url();?>Parents/add_parents"><button class="btn btn-success">View Detail</button></a>
                                                </td> -->
