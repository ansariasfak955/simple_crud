                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Introduation</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                                ...
                                <h4 class="card-title"> Introduation</h4>
                            </div>
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Introduation/add_introduation_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
