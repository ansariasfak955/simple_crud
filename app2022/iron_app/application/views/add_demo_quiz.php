            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Demo Test</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Demo Test</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Demo_video/select_demo"<button class="btn btn-info" style="float:right;">View Demo Test</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Demo Test</h4>
                            </div>
                            <!-- <hr> -->
                            <form method="POST" action="<?php echo base_url();?>Demo_video/add_demos" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                          <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
											 <!--<input type="checkbox" id="chkdwn2" value="feedback"/>-->
                                                ...
                                                <select class="form-control" name="ppck" id="dropdown"">
                                                  <option>Selected</option>
                                           <?php $saph = $this->db->query("select * from dlc_course_package");
