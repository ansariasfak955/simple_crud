            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Home_slider"<button class="btn btn-info" style="float:right;">View Home Slider</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                                ...
                                <h4 class="card-title">About Edit Home Slider</h4>
                            </div>
                            <hr>
                        
                            <form method="POST" action="<?php echo base_url('Home_slider/update_home_slider_data/'.$views[0]->id)?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12  col-md-6"><label class="control-label col-form-label">Image</label>
                                     ...
                                     <div class="col-sm-12 col-md-6 mb-3">
                                        <div class="form-group ">
                                           ...
                                           <img height="50px" weidth="50px" src="<?= base_url('/uploads/home_sliders/'.$views[0]->image)?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
