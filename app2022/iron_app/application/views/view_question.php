                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <td><select id="statuss" name="status" size="1" onChange="stat(this.value,<?php echo $row->questions_id; ?>)">
                                    ...
                                    <option value="0" <?php if($status == '0') echo "selected"; ?>>Inactive</option>
                                                ...
                                                <!-- <td> <a href="<?php echo base_url();?>Questions/answers"><button class="btn btn-info">Answer</button></a> </td> -->

                                                <td> <a href="#" data-toggle="modal" data-target="#edit<?php echo $row->questions_id; ?>"><i><button class="btn btn-info">Answer</button> </i>&nbsp;&nbsp; </a></td>

                                                <td> <a href="<?php echo base_url();?>Questions/View_answers/<?php echo $row->questions_id;?>"><button class="btn btn-info">View Answers</button></a> </td>                                         
                                                                                             
           
                                           <td>
<!-- <a href="<?php echo base_url()?>User/edit/<?php echo $row->user_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a> -->
 <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->questions_id; ?>"><i class="ti-trash"></i></a>
              
       </td>
                                            </tr><?php $i++;?>
                                            
                                            <div id="deletems<?php echo $row->questions_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
             ...
             <a href="<?php echo base_url()?>Questions/delete/<?php echo $row->questions_id; ?>">
           <button type="button" class="btn btn-default" id="modbutt">Yes</button></a>
                                ...
                                <div id="edit<?php echo $row->questions_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            <h4 class="modal-title">Add Answer - <?php echo $row->questions;?></h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo base_url();?>Questions/add_ansers" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Question:</label>
                                                        <input type="text" name="name" value="<?php echo $row->questions;?>" class="form-control" id="recipient-name" readonly>
                                                    </div>
                                                     <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Answers:</label>
                                                        <input type="text" name="ans"  class="form-control" id="recipient-name">
                                                    </div>
                        ...
                        <input type="hidden" name="id" value="<?php echo $row->questions_id;?>">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" name="submit" class="btn btn-success" value="Add Answers"> </form>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{ 
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
      ...
      xmlhttp.open("GET","<?php echo base_url(); ?>Questions/status?status="+strs+ "&id="+id,true);
     //alert("<?php echo base_url(); ?>Questions/status?status="+strs+ "&id="+id);
    xmlhttp.send();
