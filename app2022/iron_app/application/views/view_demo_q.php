                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Demo Test</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
          <a href="<?php echo base_url();?>Demo_video/add_answer"><button class="btn btn-info" style="float:right;">Add Demo Test</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
												...
												<td>
												 <?php 
												    $na = $row->pack_id;
													$sql = $this->db->query("select pack_name from dlc_course_package where pack_id ='$na'"); 
												foreach($sql->result_array() as $rrw)
												{echo  $rrw['pack_name'];}
                                                ...
                                                <td><a href="<?php echo base_url();?>Demo_video/quiz_answers/<?php echo $row->quiz_id; ?>"><button class="btn btn-success">View Answers</button></a></td>
            <td>                               
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Delete Demo Question</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this Demo Question.</h4>
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>Demo_video/delete_quiz/<?php echo $row->quiz_id; ?>">
