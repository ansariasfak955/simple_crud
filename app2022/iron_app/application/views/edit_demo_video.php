            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Demo Video</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Demo Video</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Demo_video" <button class="btn btn-info" style="float:right;">View Demo Video</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg');   ?>
                                ...
                                <h6 class="card-subtitle"></h6>
                                 <div class="row">
                                <div class="col-md-4">
                                <h4 class="card-title"> Demo Video
                                </h4></div>
                                <div class="col-md-8">
                                ...
                                <!--  <img src="<?php echo base_url();?>upload/videos/<?php echo $records[0]->   video_url;?>" style="height:80px; width:100px; float:right;"> -->
                                  <video height="150px" width="300px" controls style="float:right;">
                                     <source src="<?php echo base_url()?>/upload/defaencodevid/<?php echo $records[0]->video_url;?>" type="video/mp4" >
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Demo_video/update_row" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
