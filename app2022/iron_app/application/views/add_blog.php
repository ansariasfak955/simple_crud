...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Blog/add" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="image" accept="image/*"  class="custom-file-input" id="inputGroupFile01" required="">
									 ...
									 <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="datee" class="form-control" id="inputfname" placeholder="Title Name Here" required>
                                            </div>
                                            </div>
									 <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
