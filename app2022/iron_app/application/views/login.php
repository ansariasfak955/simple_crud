    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo base_url();?>upload/admin/2.jpg) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db" style="font-size: 18px; font-weight: 600;">Iron Gate</span>
             ...
             <form class="form-horizontal m-t-20"  method="POST" action="<?php echo base_url();?>Login/log">
                ...
                <div id="recoverform">
                    <div class="logo">
                        <span class="db" style="font-size: 18px; font-weight: 600;">Iron get</span>
