            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Notification"<button class="btn btn-info" style="float:right;">View Notification</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                                ...
                                <h4 class="card-title">About Notification</h4>
                            </div>
                            <hr>
                           <!-- <form method="POST" action="">-->
                             <form  action ="<?= base_url('Send_notification/add_notification') ?>" method="POST">
                            <div class="card-body">
                                <div class="row">
                                     <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label for="email1" class="control-label col-form-label"> Title</label>
                                            <input type="text" name="title" autocomplete="off" class="form-control" id="email1" placeholder="Title" required>
                                        </div>
                                    </div> 
                                     ...
                                     <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label for="email1" class="control-label col-form-label"> Description</label>
                                              <textarea type="text" name="desc" class="form-control" rows="8" autocomplete="off" placeholder="Description" required></textarea>
                                        </div>
                                    </div>          
                            ...
                            <div class="card-body">
                                <div class="action-form">
                                    <div class="form-group m-b-0 text-right">
                                        <!--<button type="submit" name="submit" class="btn btn-info waves-effect waves-light">Send</button>-->
