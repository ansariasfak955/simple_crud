            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Favorite</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Favorite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                   <!--  <div class="col-7 align-self-center">
          <a href="<?php echo base_url();?>Product/add_product"><button class="btn btn-info" style="float:right;">Add Product</button></a>
                    </div> -->
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                <!-- ============================================================== -->
<form method="GET" style="margin-bottom:10px;" action="<?php echo base_url()?>Product/view_favorite">
    <div class="col-md-12">
        <div class="row">       
            <div class="col-md-3">
                <label>Products</label>
                <input type="text" id="search-box" name="prod_name" class="form-control" placeholder="Product Name" style="height:36px;">
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                                ...
                                                <td><img height="50px"width="50px" src="<?= base_url('uploads/product_images/'.$row->prod_image)?>" alt=""></td>
                                        ...
                                        <tfoot>
                                           <tr>
                                            ...
                                            <th>User Name</th>
                                            <th>Product Name</th>
                                            <th>Product Image</th><th>Date</th>
