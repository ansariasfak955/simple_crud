...
<body>
    ...
    <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Slider/add_slider"><button class="btn btn-info" style="float:right;">Add Slider</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<div class="alert alert-success" id ="alt">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        <td><a href="<?= base_url('Slider/edit_slider/').$row->id ?>"   ><button class="btn btn-success"> Edit  </button></a></td>
        

        <td><a href="<?= base_url('Slider/delete_slider/').$row->id ?>"   ><button class="btn btn-danger"> Delete  </button></a></td>
