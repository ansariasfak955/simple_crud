...
<body>
    ...
    <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Videos/add_upload_video"><button class="btn btn-info" style="float:right;">Add Videos</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<div class="alert alert-success" id ="alt">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                             ...
                                             <!-- <td>
                                      <video height="100px" width="200px" controls>
                                     <source src="<?php echo base_url()?>/upload/videos/<?php echo $row->video_url;?>" type="video/mp4">
                                    ...
                                    <option value="0" <?php if($status == '0') echo "selected"; ?>>Inactive</option>
                                            ...
                                            <td><a href="<?php echo base_url()?>Videos/edit/<?php echo $row->videos_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
                                            <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->videos_id; ?>"><i class="ti-trash"></i></a>
                                            </td>

                                               
                                            </tr><?php $i++;?>
                <div id="deletems<?php echo $row->videos_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
             ...
             <a href="<?php echo base_url()?>Videos/deletee/<?php echo $row->videos_id; ?>">
