...
<?php
 ...
 $mess1 = $this->session->flashdata('success_form_msg');  $mess2 = $this->session->flashdata('error_form_msg'); 
   ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url('Product/update_product_gallary/'.$view->prod_id);?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <input type="hidden"name="id" value="<?=$view->id;?>">
                                     <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="<?=$view->title;?>" autocomplete="off" class="form-control" id="title" placeholder="Enter title" required>
                                        </div>
                                    </div> 						
                                <div class="col-12  col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <input type="hidden"name="hidden_image" value="<?=$view->image;?>">
                                            <label class="custom-file-label" for="inputGroupFile01">Choose image</label>
                                        </div>
                                    </div>
                                </div>
                                <img height="50px"width="50px" src="<?= base_url('common_uploads/product_gallary_images/'.$view->image)?>" alt="">
   ...
   ?>
                           ...
                           <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                        <?php  $i=1; foreach($all_gall as $row){?>
                                            <tr>
                                                <td><?php echo $i;?></td>
                                           ...
                                           <td>
<a href="<?php echo base_url('Product/edit_gallary/'.$row->id);?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
 <a href="<?php echo base_url('Product/delete_gallary/'.$row->id);?>"onclick="return confirm('Are you sure ?')"><i class="ti-trash"></i></a>
