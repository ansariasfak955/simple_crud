                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               $ssqp = $this->db->query("select * from dlc_user where user_id ='$id'");
                                       foreach($ssqp->result_array() as $rdds)
                                       {
                                         $cont  =  $rdds['user_contact'];  
                                       }
                                ?>
                                 <h5 style=""> Contact Number : <?php echo $cont; ?></h5>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                        <?php  $i=1; foreach($rf as $row){
                                                   $num = $row->contect;
                                                $query1 = $this->db->query("SELECT * FROM  dlc_user where user_contact='$num'");
