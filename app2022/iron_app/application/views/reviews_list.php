		   ...
		   <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Reviews</h4>
          ...
          <a href="<?php echo base_url();?>Rating/add_ret"><button class="btn btn-info" style="float:right;">Add Reviews</button></a>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                 ...
                 <!--
                  <form method="POST" style="margin-bottom:10px;" action="<?php echo base_url()?>Rating/viewreview">
            ...
            <div class="col-md-12">
             ...
             <select class="form-control" name="sears">
                 <option value="0">Select</option>
             <?php 
             $ssqdd = $this->db->query("select * from dlc_course_package");
                  foreach($ssqdd->result_array() as $rwg)
                  {
              ?>
                <option value="<?php echo $rwg['pack_id'];?>">
                   <?php echo $rwg['pack_name']; ?>
               </option>
               <?php } ?>
             </select>
                     </div>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            ...
                                            <tr>
                                               ...
                                               $user = $row->user_id;
                                                ...
                                                <td><?php echo $row->comment;?></td>
												 <td>
												 <?php      
                                	                   $temp_stars = $row->rateStar;
                                	                   if (10<$row->rateStar) {
                                	                        echo "RATING EXCEEDS MAXLENGTH";
                                	                         }
                                	                        else{
                                	                   for($i=$temp_stars; $i<=10; $i++){
                                		                if ($temp_stars >= 1) {
                                			           ?><img src="<?php echo base_url();?>upload/a.png" width="30"/><?php
                                			             $temp_stars--;
                                		                     }
                                							 else{
                                								 if($temp_stars >= 0.5){
                                		                         ?>   <img src="<?php echo base_url();?>upload/b.png" width="30"/><?php
                                				                   $temp_stars -= 0.5;	
                                			                 }else{
                                				                  echo '<img src="" width="40"/>';
                                			  ...
                                			  ?>
												 ...
												 <td>
												 <select id="statuss" name="status" size="1" onChange="stat(this.value,<?php echo $row->rating_id; ?>)">
              <?php echo $status = $row->status; ?>
                                    ...
                                    <option value="0" <?php if($status == '0') echo "selected"; ?>>Inactive</option>
                                           ...
                                           <td>
 <a href="<?php echo base_url();?>Rating/edit/<?php echo $row->rating_id; ?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
