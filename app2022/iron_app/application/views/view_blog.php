                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            ...
                                            <td> <img src="<?=base_url('uploads/blog/').$row->image  ?>" alt="" width="50px" height="50px">
                                        <!--<video height="150px" width="150px" controls>
                                     <source src="<?php echo base_url()?>/upload/demo_video/<?php echo $row->video_url;?>" type="video/mp4">
                                    ...
                                    <option value="0" <?php if($status == '0') echo "selected"; ?>>Inactive</option>
                                            ...
                                            <td><a href="<?php echo base_url()?>Blog/update_rows/<?php echo $row->bl_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
											 <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->bl_id; ?>"><i class="ti-trash"></i></a>
                                            </td>

                                               
                                            </tr><?php $i++;?>
                                            
                                         <div id="deletems<?php echo $row->bl_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this blog.</h4>
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>Blog/delete/<?php echo $row->bl_id; ?>">
