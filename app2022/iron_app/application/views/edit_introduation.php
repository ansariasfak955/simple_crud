                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Words</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>Introduation" <button class="btn btn-info" style="float:right;">View Introduation</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg');   ?>
                                ...
                                <h6 class="card-subtitle"></h6>
                                 <div class="row">
                                <div class="col-md-4">
                                <h4 class="card-title"> Words
                                </h4></div>
                                <div class="col-md-8">

                                <!--  <img src="<?php echo base_url();?>upload/videos/<?php echo $records[0]->   video_url;?>" style="height:80px; width:100px; float:right;"> -->
                                  <video height="50px" width="50px" controls style="float:right;">
                                     <source src="<?php echo base_url()?>/upload/Introduation/<?php echo $records[0]->video_url;?>" type="video/mp4" >
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Introduation/update_row" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="inputfname" class="control-label col-form-label">Titel</label>
                                            <input type="text" name="tit" class="form-control" id="inputfname" value="<?php echo $records[0]->title;?>">
                                        </div>
                                    </div>
