            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Advertisement Category</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Advertisement Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php $i=1; foreach($views as $row){?>
                                            <tr>
                                                ...
                                                <!-- <td><img src="<?php echo base_url();?>upload/category/<?php echo $row->cat_image;?>" style="height:60px; width:80px;"></td> -->
       <td>
       <a href="#" data-toggle="modal" data-target="#edit<?php echo $row->advertisementcat_id; ?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a>
       <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->advertisementcat_id; ?>"><i class="ti-trash"></i></a>
       </td>
                                            </tr><?php $i++ ; ?>
                                            
                                            <div id="deletems<?php echo $row->advertisementcat_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
             ...
             <a href="<?php echo base_url()?>Advertise_category/delete/<?php echo $row->advertisementcat_id; ?>">
           <button type="button" class="btn btn-default" id="modbutt">Yes</button></a>
                                ...
                                <div id="edit<?php echo $row->advertisementcat_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Edit - <?php echo $row->advertise_name;?></h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo base_url();?>Advertise_category/update_row" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Category:</label>
                                                        <input type="text" name="name" value="<?php echo $row->advertise_name;?>" class="form-control" id="recipient-name">
                                                    </div>
                       ...
                       <!-- <input type="hidden" name="oldimage" value="<?php echo $row->cat_image;?>"> -->
                        <input type="hidden" name="id" value="<?php echo $row->advertisementcat_id;?>">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?php echo base_url();?>Advertise_category/add" enctype="multipart/form-data" class="m-t-20">
                                    <div class="form-group">
