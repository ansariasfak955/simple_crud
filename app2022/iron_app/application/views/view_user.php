        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- ============================================================== -->
                 ...
                 <form method="GET" style="margin-bottom:10px;" action="<?php echo base_url()?>User/index">
            <div class="col-md-12">
             <div class="row">
             ...
             <input type="text" id="search-box" autocomplete="off"  name="usr" class="form-control" placeholder="User Name" style="height:36px;">
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>User/friendsearch",
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>User/friendsearchh",
data:'keyword='+$(this).val(),
beforeSend: function(){
//$("#search-boxx").css("background","#FFF url(LoaderIcon.gif) no-repeat 165px");
},
success: function(data){
