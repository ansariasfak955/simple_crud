  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                              <?php $bml = $this->session->userdata('some_value'); ?>
                                <a href="<?php echo base_url();?>Quiz/select_preview/<?php echo $bml; ?>"<button class="btn btn-info" style="float:right;">Preview</button></a>

                                <h4 class="card-title">Questions</h4>  
                            </div>
                            <!-- <hr> -->
                            <?php
                            /* $sqlllh = $this->db->query("select pack_id from dlc_quiz order by quiz_id desc limit 1");
                                        foreach($sqlllh->result_array() as $rhkmp){ $mmuy = $rhkmp['pack_id'];}*/
                                        
                             ?>
                            <form method="POST" action="<?php echo base_url();?>Quiz/add_quiz" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                          <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="inputfname" class="control-label col-form-label">Courses</label>
                                                
                                                <select class="form-control" name="ppck">
                                                  <option>Selected</option>
                                                  <?php   
                                                  $saphs = $this->db->query("select * from dlc_course_package where pack_id = '$bml' ");
                                                        foreach($saphs->result_array() as $mklp){ ?>
                                                            
                                                    <option value="<?php echo $mklp['pack_id'];?>" selected=""> 
                                                    <?php echo $mklp['pack_name']; ?></option>        
                                                    <?php 
                                                      }
                                                  
                                                   ?>
                                                  
                                           <?php $saph = $this->db->query("select * from dlc_course_package where pack_id !='$bml'");
                                                    foreach($saph->result_array() as $arw)
                                                    {
                                               ?>
                                                  <option value="<?php echo $arw['pack_id'];?>"> 
                                                    <?php echo $arw['pack_name']; ?></option>
                                                  <?php } ?>
                                                </select>
                                              </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12" id="red">
                                        <div class="form-group">
                                            <label for="email1" class="control-label col-form-label">Fill In The Blank</label>
                                            <!-- <input type="text" name="fill" autocomplete="off" class="form-control" id="email1" placeholder="Quiz Question" > -->
                                    <!--<textarea class="form-control" name="fill" style="width:660px; height: 100px;"> enter answer </textarea>-->
                                         <div class="row">
