...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Device ID Requests</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>Home">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Device ID Requests</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   $mup = $this->session->flashdata('successm_msg');
      ?>
                                
                                <?php if($mess1 || $mess2 || $mup){?>
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    <span class="badge badge-info"><i class="fas fa-info"></i></span>
                                    <strong> <?php echo $mess1 ; ?> <?php echo $mess2 ; ?> <?php echo $mup; ?></strong>
                                    ...
                                    foreach($view as $row)
                                        {?>
                                            <tr>
                                                ...
                                                <td> <a href="<?= base_url().'User/user_device_id_empty/'.$row->mobile_no ?>">
                                                        <button class="btn btn-success">Device Id Empty</button>
                                                      </a>
                                                     </td>
                                                </tr><?php $i++;?>
                                          <?php }?>
