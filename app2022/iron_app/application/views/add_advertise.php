                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Advertise</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">About Advertise</h4>
                            </div>
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Advertise/add_advertise_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="inputfname" class="control-label col-form-label">Advertise Name</label>
                                                <input type="text" name="advertisename" class="form-control" id="inputfname" placeholder="Advertise Name Here" required>
                                            </div>
                                        </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="inputlname2" class="control-label col-form-label">Advertise Url</label>
                                            <input type="text" name="adertiseurl" class="form-control" id="inputlname2" placeholder="Advertise Url Here" required>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="col-sm-12 col-md-6">-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label for="email1" class="control-label col-form-label">Advertise Category</label>-->
                                    <!--        <select class="form-control" name="advcat">-->
