...
<body>
    ...
    <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
          ...
          <a href="<?php echo base_url();?>Questions"><button class="btn btn-info" style="float:right;">View Questions</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                                <td><?php echo $i;?></td>
                                                <td> <?php echo $row->answer_detail; ?>  </td>  
                                                
                                    <td><select id="statuss" name="status" size="1" onChange="statt(this.value,<?php echo $row->answers_id; ?>)">
...
<!-- <a href="<?php echo base_url()?>User/edit/<?php echo $row->user_id;?>"><i class="ti-pencil"></i>&nbsp;&nbsp; </a> -->
 <a href="#" data-toggle="modal" data-target="#deletems<?php echo $row->answers_id; ?>"><i class="ti-trash"></i></a>
              
       </td>
                                            </tr><?php $i++;?>
                                            
                                            <div id="deletems<?php echo $row->answers_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4>Sure you want to delete this Answer.</h4>
                                                <p></p>
                                               
                                            </div>
                                            <div class="modal-footer">
             <a href="<?php echo base_url()?>Questions/detete_answer/<?php echo $row->answers_id; ?>">
...
{ 
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
      ...
      xmlhttp.open("GET","<?php echo base_url(); ?>Questions/status_update?status="+strs+ "&id="+id,true);
