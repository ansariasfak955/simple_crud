                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-12 col-md-12" id="ifYes">
                                        ...
                                        <?php
                                            ...
                                            $qssdid = $qz[0]->quiz_id;
                                        $ssql = $this->db->query("select * from dlc_quiz_answers where quiz_id = '$qssdid'");
                                    ...
                                    <?php } ?>
                                     ...
                                     <div class="col-sm-12 col-md-12" id="ifNo">
                                        ...
                                        $ssqlml = $this->db->query("select * from dlc_quiz_answers where quiz_id = '$qssdidm'");
                                ...
                                <div class="action-form">
                                    <div class="form-group m-b-0 text-right">
                                     ...
                                     <div class="col-sm-12 col-md-12" id="ifYes">
                                        ...
                                        $ssql = $this->db->query("select * from dlc_quiz_answers where quiz_id = '$qssdidfl'");
                                            foreach($ssql->result_array() as $snw)
                                            {
...
function pro(strs,id,nid)
{
  ...
  xmlhttp = new XMLHttpRequest();
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
     ...
     xmlhttp.open("GET","<?php echo base_url();?>Quiz/update_answerss?status="+strs+ "&id="+id+"&nid="+nid,true);
...
function mltpro(strs,id,nid)
{
  ...
  xmlhttp = new XMLHttpRequest();
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
     ...
     xmlhttp.open("GET","<?php echo base_url();?>Quiz/update_multiple_data?status="+strs+ "&id="+id+"&nid="+nid,true);
...
function pro_fill(strsfl,idfl,nidfl)
{
  ...
  xmlhttp = new XMLHttpRequest();
   ...
   { if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
     ...
     xmlhttp.open("GET","<?php echo base_url();?>Quiz/update_answerss_fill?status="+strsfl+ "&id="+idfl+"&nid="+nidfl,true);
       //alert("<?php echo base_url();?>Quiz/update_answerss?status="+strs+ "&id="+id);
