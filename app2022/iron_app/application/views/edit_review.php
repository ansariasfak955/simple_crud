...
<div class="alert alert-success" id ="alt">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      ...
      <form method="POST" action="<?= base_url("Home/update_reviews/$con->id") ?>" enctype="multipart/form-data">
        <div class="card-body">
            <div class="row">
               <div class="col-sm-12">
                        <div class="form-group">
                            <label for="inputfname" class="control-label col-form-label">Customer Name</label>
                            <input type="text" name="name" value="<?=$con->customer_name?>" class="form-control" placeholder="Enter name Here" required>
                        </div>
                    </div>
                 
                  <div class="col-12 ">
                     <label class="control-label col-form-label">Description </label>
                         <textarea  name = 'description' row="35" ><?=$con->description?></textarea>
                </div>
