                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Home Slider</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
          <a href="<?php echo base_url();?>Home_slider/add_home_slider"><button class="btn btn-info" style="float:right;">Add Home Slider</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i=1; foreach($view as $row){?>
                                            <tr>
                                                ...
                                                <td><img height="50px" weidth="50px" src="<?= base_url('./common_uploads/home_sliders/'.$row->image)?>" alt=""></td>
                             
        <td>
            <div class="d-flex">
            <a href="<?= base_url('Home_slider/edit_home_slider/'.$row->id) ?>"   ><button class="btn btn-success mr-4"> Edit  </button></a>
            <a href="<?= base_url('Home_slider/delete_home_slider/'.$row->id) ?>" onclick="return confirm('Are you sure?')"  ><button class="btn btn-danger"> Delete  </button></a>
            </div>
        </td>
