            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <a href="<?php echo base_url();?>User"<button class="btn btn-info" style="float:right;">View Slider</button></a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
...
<?php
 ...
 $mess1 = $this->session->flashdata('success_msg');  $mess2 = $this->session->flashdata('error_msg'); 
   ?>
                            ...
                            <hr>
                            <form method="POST" action="<?php echo base_url();?>Slider/add_slider_data" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
