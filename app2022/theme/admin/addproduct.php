                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation add-product-form" action="productHandler.php" method="POST" enctype="multipart/form-data">
                                    <div class="col-xl-5">
                                        <div class="add-product">
                                            <div class="row">
                                                <div class="col-xl-9 xl-50 col-sm-6 col-9">
                                                    <img src="#" type="file" name="image"  alt="" class="img-fluid image_zoom_1 blur-up lazyloaded">
                                                </div>
                                    ...
                                    <div class="col-xl-7">
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustomUsername" type="text" name="product_code" required="">
                                            ...
                                            <div class="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <select class="form-control digits " id="exampleFormControlSelect1" name="select_size">
                                                            <option>Small</option>
                                                    ...
                                                    <div class="col-xl-9 col-xl-8 col-sm-7 pl-0">
                                                        <fieldset class="qty-box ">
                                                            <div class="input-group">
                                                                <input class="touchspin" type="text" value="1" name="total_product">
                                                            </div>
                                                        </fieldset>    
                                                    </div>
                                                </div>
                                            ...
                                            <div class="offset-xl-3 offset-sm-4">
                                                <button type="submit" name="product_save" class="btn btn-primary">Add</button>
