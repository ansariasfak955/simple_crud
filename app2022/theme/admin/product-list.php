...
$shwoquery = "SELECT * FROM `product`";
                ...
                // echo "</pre>";
                // foreach($row as $data){
                //     echo $data['id'] . " " . $data['price'] . " ". $data['product_code'] . " ". $data['select_size'] . " ". $data['total_product'] . " ". $data['description'] ."<br>";
                // }
               //print_r($q); die();
                                ...
                                <div class="product-box p-0">
                                    <div class="product-imgbox">
                                        <div class="product-front">
                                            <img src="uploads/<?=$data['image'] ?>" class="img-fluid  " alt="product">
                                        </div>
