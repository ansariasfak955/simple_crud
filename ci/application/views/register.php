...
<body>
    <div class="container-fluid register">
        ...
        <!--start form-->
        <form action="<?php echo base_url('Student/registerData')?>" method="POST">
            <div class="row justify-content-center" style="font-weight: 500;">
                ...
                Email :
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="text" name="email" class="form-control" placeholder="Enter Your Email" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                </div>  
            </div>
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                <div class="col-sm-4">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="number" name="number" class="form-control" placeholder="Enter Your Number" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
