...
<body>
    <div class="container-fluid register">
        ...
        <!--start form-->
        <form action="<?php echo base_url().'Employee/updatedata/'.$employee['id'];?>" method="POST" enctype="multipart/form-data">
            <div class="row justify-content-center" style="font-weight: 500;">
                <div class="col-sm-4">
                    Name :
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                        <input type="text" value="<?php echo $employee['name']?>" name="name" class="form-control" placeholder="Enter Your Name" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                <div class="col-sm-4">
                <select name="city" value="<?php echo $employee['city']?>" class="form-select" aria-label="Default select example">
            ...
            <div class="row justify-content-center" style="font-weight: 500;">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" value="<?php echo $employee['description']?>" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                </div>  
            </div>
