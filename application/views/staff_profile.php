           ...
           <div class="box box-slided-up bgsetiing">
             ...
             <div class="box-body" style="display: block;">
               <form action="<?= base_url('Staff/staff_update_info_1/').$this->uri->segment(3) ?>" 
                 ...
                 <div class="form-floating mb-3">
                   <input type="text" class="form-control"  name="allergies" value="<?= isset($user_tbl[0]->name)? $user_tbl[0]->name  : '' ?>">
                   <label for="allergies">Allergies</label>
                 </div>

                 <div class="form-floating mb-3">
                   <input type="text" class="form-control"  name="medications" value="<?= isset($user_tbl[0]->name)? $user_tbl[0]->name  : '' ?>">
             ...
             <div class="box-body" style="display: block;">
               <div class="view_info">
                 ...
                 <div class="dflex">
                   ...
                   <h5>demo 1, demo2, demo3-, demo4, Demo Room</h5>
                 </div>
                 <div class="dflex">
                   <label>Schedule</label>
                   <a href="#">View all staff schedules</a>
                 </div>
               </div>
             </div>
           </div>
                 ...
                 <div class="tab-content">
                   <div id="navpills-1" class="tab-pane active">
                     <form action="#" method="post">
                       ...
                       <div class="form-floating mb-3">
                         <input type="text" class="form-control" id="fistname" placeholder="name@example.com" name="fistname">
                       ...
                       <div class="form-floating mb-3">
                         <input type="text" class="form-control" id="datecomplete" placeholder="name@example.com" name="datecomplete">
                         <label for="datecomplete">Date completed</label>
                       </div>
                       <div class="form-floating mb-3">
                         <input type="number" class="form-control" id="number" placeholder="name@example.com" name="number">
                         <label for="hours">Number of hours</label>
                       </div>
                       <div class="form-floating mb-3">
                         <input type="text" class="form-control" id="notes" placeholder="name@example.com" name="notes">
