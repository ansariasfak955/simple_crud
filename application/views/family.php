   ...
   <div class="container-full">
     ...
     <div class="content-header">
       <div class="tabls-title">
         ...
         <a href="<?= base_url('Student/family/') ?>" class="active">Family</a>
               ...
               <div class="card-body">
                 <div class="row">
                   <div class="col-lg-3 col-md-4 col-sm-6">
        						...
        						<input text="search" id="myHouse" placeholder="type here..." class="form-control input-pad" />	    	    
        		                 <div id="result"></div>
                     ...
                     <tr>
                       ...
                       <td>  
                        ...
                        <?php 
                           ...
                           <a href="#" data = "<?= base64_encode(json_encode($val)) ?>" class="btn btn-primary waves-effect waves-light addSparent">Add Family </a>
                             <?php }?>
     ...
     <div class="modal-content">
       ...
       <div class="modal-body box-body">
        <form action="<?= base_url('Student/edit_Parents') ?>" method="post">
           ...
           <div class="form-floating mb-3">
             <input type="tal" class="form-control" id="edit_mobile"  name="mobile" title="Please use a 10 digit telephone number" 
       ...
       <div class="modal-body">
         ...
         <div class="box-body">
          ...
          <div class="tab-content">                                     
           ...
           <input type = 'hidden'  name = 'relational' value = 'Family'>
           <div class="form-floating mb-3">
