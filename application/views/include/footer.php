  ...
  <footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
	 ...
	 <!--  &copy;<a href="#">MeritCard 2022</a>. All Rights Reserved. -->
  </footer>
  <!-- Side panel --> 
                        ...
                        <div class="card no-shadow b-0" style="margin-bottom: 0 !important;">
                            <div class="test">
                                <div class="card-header d-block">
                                    <div class="media p-0">
                                        <img class="img-fluid w-50 ms-0" src="#" alt="placeholder image">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="d-inline-block">
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="#" alt="placeholder image">
                                                </a>
                                                <a href="#">
                                                    <img class="img-fluid w-30" src="#" alt="placeholder image">
                                                </a>
...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> -->
	...
	<!-- Vendor JS -->
	<script src="<?= base_url() ?>assets_pages/js/vendors.min.js"></script>

    <script src="<?= base_url() ?>assets_pages/vendor_components/sweetalert/jquery.sweet-alert.custom.js"></script>
	
    <script src="<?= base_url() ?>assets_pages/vendor_components/sweetalert/sweetalert.min.js"></script>
    <script src="<?= base_url() ?>assets_pages/vendor_components/sweetalert/jquery.sweet-alert.custom.js"></script>

    <script src="<?= base_url() ?>assets_pages/js/template.js"></script>
    <script src="<?= base_url() ?>assets_pages/js/pages/dashboard.js"></script>
