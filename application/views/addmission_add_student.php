              ...
              <div class="card-body">
                  ...
                  <div class="col-lg-12 col-md-4 col-sm-6">
                   ...
                   <label class="labels mt-0">STATUS<span class="reduired">*</span></label>
                    <label class="select_schedule" for="prospect">
                        <input type="radio" name="s_status" value = 'Prospect' id="prospect" checked="">
                  ...
                  <div class="col-lg-6">
                   ...
                   <div class="col-lg-6 mb-3">                         
                    <div class="formsetting mb-3">
                     ...
                     <select  class="selectpicker form-control" id="minage" data-container="body" data-live-search="true" title="Select.." data-hide-disabled="false" data-actions-box="true" data-virtual-scroll="false" name="class_id">
                ...
                <div class="col-lg-6 mb-2 mycheckboxdiv mt-4">
                        <div class="form-floating mb-3">
                              ...
                              <label class="sdatel newlabel"  for="start"> DOB date </label>
                       </div>
                     </div> 
             <div class="col-lg-6 mb-2 mycheckboxdiv mt-4">
                        <div class="form-floating mb-3">
                              <input type="number" class="form-control" minlength= '1'  name="age" >
                            
                              <label class=""  for="start"> Student age</label>
                       </div>                    
                </div>                                                      
             <div class="col-lg-12 mb-3 mycheckboxdiv">
               <div class="controls week_show" style="">
